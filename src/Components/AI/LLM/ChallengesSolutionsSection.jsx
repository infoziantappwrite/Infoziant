...
const ChallengesSolutionsSection = () => {
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-r from-[#0a192f] via-[#112240] to-[#1a365d] text-gray-100">
      {/* Background Effects */}
      ...
      <div className="relative z-10 px-4 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Challenges Card */}
          <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg overflow-hidden border border-white/10 hover:border-red-400 transition duration-300">
            <div
          ...
          {/* Solutions Card */}
          <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg overflow-hidden border border-white/10 hover:border-teal-400 transition duration-300">
            <div
              className="h-32 bg-cover bg-center relative flex items-end px-6 py-4 text-white"
              style={{
                backgroundImage:
